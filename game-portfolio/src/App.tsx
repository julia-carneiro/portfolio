      ...
      >
        ...
        <Tabs defaultValue="games" className="max-w-4xl mx-auto">
          ...
          <TabsContent value="art3d">
            <h3 className="text-l font-semibold text-gray-800 mb-4 text-center">{languageContent[language].text3d.text}</h3>     
            <motion.div 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="grid md:grid-cols-2 lg:grid-cols-3 gap-6"
                ...
                >
                  <div className="grid md:grid-cols-2 gap-6 p-6 relative">
                    ...
                    <div className="relative">
                      <AnimatePresence mode="wait">
                        <motion.img
                          ...
                          alt={`${selectedArt.title} screenshot`}
                          initial={{ opacity: 0 }}
                          animate={{ opacity: 1 }}
                          exit={{ opacity: 0 }}
                          className="w-full h-96 object-cover rounded-lg"
                    ...
                    <div className="space-y-4">
                      ...
                      {/* Plataforms */}
                      {selectedArt.plataformas && (
                        <div>
                          <h3 className="font-semibold text-gray-800 mb-2">
                            {languageContent[language].details.plataformas}
                          </h3>
                          <div className="flex flex-wrap gap-2">
                            {selectedArt.plataformas.map((tech) => (
                              <span 
                                key={tech}
                                className="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm"
                              >
